...
// RedirectSafeIntent implements api.RedirectSafe: artifact downloads may be
// answered with a pre-signed redirect. Checksum sidecars and metadata are
// generated by the registry and must be streamed.
func (Module) RedirectSafeIntent(intent api.Intent) bool {
	return intent.Kind == api.IntentArtifact && intent.WantChecksum == ""
}
